...
(function () {
  ...
  return function (argData, argParams, external) {
    ...
    try {
      ...
      const lineText = lines[paragraphIndex] !== undefined ? lines[paragraphIndex] : "";
      chapterMark.paragraphMarks[String(paragraphIndex)] = { lineNo: paragraphIndex + 1, text: lineText };
      chapterMark.paragraphs[paragraphIndex] = lineText;
      ...
      return {
        ...
        response: {
          code: 200,
          data: { success: true, data: { markedAt: chapterMark.markedAt, paragraphIndex } },
        },
      };
    } catch (error) {
      return { isWrite: false, response: { code: 200, data: { success: false, msg: "段落标记失败: " + error.message } } };
    }
  };
})();
