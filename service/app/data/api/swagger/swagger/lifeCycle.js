(function () {
  return function () {
    const fs = require("fs");
    const swaggerFolderPath = "./data/api/swagger/swagger/docs";
    const publicFolderPath = "./data/api/swagger/swagger/public";
    const generateMockDataWithProjectPath = `${publicFolderPath}/generateMockDataWithProject.js`;
    const generateAjaxCodeFolderpath = "./data/api/swagger/swagger/generateAjaxCode";
    return {
      createFloder: function (createFloder, external) {
        ...
        external.createGenerateAjaxCodeJs = (projectName) => {
          if (!fs.existsSync(generateAjaxCodeFolderpath)) {
            fs.mkdirSync(generateAjaxCodeFolderpath, { recursive: true });
          }
