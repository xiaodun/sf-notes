...
大乐透号码预测工具，支持自动生成号码、查询开奖结果、自动匹配计算中奖情况。[使用文档](./manual/6大乐透/大乐透.md)

## 段子

段子浏览和管理工具，支持添加、编辑、删除段子，提供列表模式和随机模式两种浏览方式。[使用文档](./manual/7段子/段子.md)

## 名篇

名篇浏览和管理工具，支持按作者、朝代搜索，添加、编辑、删除名篇，提供分页加载功能。[使用文档](./manual/8名篇/名篇.md)

## 警句

警句浏览和管理工具，支持添加、编辑、删除警句，提供列表模式和随机模式两种浏览方式，支持按标点符号自动格式化。[使用文档](./manual/9警句/警句.md)
