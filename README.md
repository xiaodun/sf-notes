...
按分组管理接口、公共前缀与 Headers，发送请求并查看响应；支持大响应落盘、按需树形浏览与远程搜索正文。[使用文档](./manual/14API/API.md)
...
支持批量的图片裁剪、压缩。[使用文档](./manual/13图片/图片应用.md)
...
行为记录和管理工具，支持创建行为、添加打卡记录、标签管理等功能。支持加密功能保护隐私数据，提供时间轴可视化展示打卡记录。支持加密/解密切换，自动加密或解密所有相关数据（包括记录、标签、时间字段等）。[使用文档](./manual/10行为/行为.md)

## 小说

小说阅读和管理工具，支持添加本地小说，按照中文阅读习惯自动格式化文本，提供流畅的阅读体验。[使用文档](./manual/12小说/小说.md)
...
!\[扫描二维码]\(./manual/images/scanQrcode.png null)
